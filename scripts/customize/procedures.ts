...
/**
 * Hard-coded "Implant Treatment Options" / service categories for specific procedures.
 * When a procedure key is present here, the customize + regen pipelines use this exact
 * list verbatim instead of asking the AI to generate `clinic.implantOptions`.
 * Procedures NOT listed here continue to be generated by the AI (same method as before).
 */
export const SERVICE_CATEGORIES_FIXED: Partial<Record<ProcedureKey, PillarItem[]>> = {
  "dental-implants": [
    { title: "Single Tooth Implants", description: "Replace one missing tooth with a durable implant and natural-looking crown." },
    { title: "Multiple Tooth Implants", description: "Restore several missing teeth with strategically placed implants for a secure, long-lasting solution." },
    { title: "Implant-Supported Bridges", description: "Replace multiple adjacent missing teeth without relying on natural teeth for support." },
    { title: "Implant-Supported Dentures", description: "Secure dentures to dental implants for improved comfort, stability, and chewing function." },
    { title: "All-on-4 Dental Implants", description: "Restore a full arch of teeth using four strategically placed implants and a fixed prosthesis." },
    { title: "Same-Day Dental Implants", description: "Receive implants and a temporary restoration in a single visit, reducing treatment time and restoring your smile quickly." },
  ],
  veneers: [
    { title: "Porcelain Veneers", description: "Durable, stain-resistant veneers that provide a natural-looking smile transformation." },
    { title: "Composite Veneers", description: "A cost-effective solution using tooth-colored resin to improve the appearance of teeth." },
    { title: "No-Prep Veneers", description: "Ultra-thin veneers that require little to no removal of natural tooth enamel." },
    { title: "Minimal-Prep Veneers", description: "Conservatively designed veneers that preserve more of the natural tooth structure." },
    { title: "Lumineers®", description: "Thin, custom-made veneers that can often be placed without extensive tooth preparation." },
    { title: "Smile Makeover Veneers", description: "Multiple veneers strategically placed to create a balanced, uniform, and attractive smile." },
  ],
  "full-mouth-restoration": [
    { title: "Dental Implants", description: "Replace missing teeth with permanent, natural-looking restorations that restore chewing ability, jawbone health, and confidence." },
    { title: "Implant-Supported Dentures", description: "A secure alternative to traditional dentures that uses dental implants for improved stability, comfort, and function." },
    { title: "Dental Crowns & Bridges", description: "Restore damaged, weakened, or missing teeth with custom-crafted restorations designed for strength, aesthetics, and long-term durability." },
    { title: "Porcelain Veneers", description: "Enhance the appearance of worn, chipped, stained, or uneven teeth with thin, natural-looking porcelain shells." },
    { title: "Full & Partial Dentures", description: "Replace multiple missing teeth with custom dentures that improve speech, chewing efficiency, and smile aesthetics." },
    { title: "Bite Reconstruction & TMJ Therapy", description: "Correct bite misalignment, excessive tooth wear, and jaw discomfort to restore proper function and long-term oral health." },
  ],
  "all-on-4-dental-implants": [
    { title: "Single Tooth Dental Implants", description: "Replace one missing tooth with a single implant and custom crown." },
    { title: "Implant-Supported Bridges", description: "Replace multiple adjacent missing teeth without relying on natural teeth for support." },
    { title: "All-on-4 Dental Implants", description: "Restore a full arch of missing teeth using four strategically placed dental implants." },
    { title: "All-on-6 Dental Implants", description: "Provide enhanced stability and support for a full arch restoration using six implants." },
    { title: "Full Mouth Dental Implants", description: "Replace all missing teeth in both upper and lower arches with implant-supported restorations." },
    { title: "Same-Day Dental Implants", description: "Receive dental implants and temporary teeth in a single appointment, where clinically appropriate." },
  ],
  invisalign: [
    { title: "Teen Invisalign", description: "Clear aligners designed specifically for growing teens with active lifestyles." },
    { title: "Adult Invisalign", description: "A discreet orthodontic solution for adults seeking a straighter smile." },
    { title: "Express Invisalign", description: "Fast treatment for minor spacing, crowding, or alignment concerns." },
    { title: "Comprehensive Invisalign", description: "Full orthodontic treatment for moderate to complex alignment issues." },
    { title: "Invisalign for Crowded Teeth", description: "Corrects overlapping and crowded teeth for improved function and appearance." },
    { title: "Invisalign for Gaps & Spacing", description: "Closes unwanted spaces between teeth to create a more balanced smile." },
  ],
};

/** Returns the hard-coded service categories for a procedure key, or null if it should be AI-generated. */
export function fixedServiceCategories(key: string | undefined): PillarItem[] | null {
  if (!key) return null;
  return SERVICE_CATEGORIES_FIXED[key as ProcedureKey] ?? null;
}
